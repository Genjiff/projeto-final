...
Na solução proposta pelo presente trabalho, utilizando o algoritmo de \citeonline{chen2015invisible} para detectar os momentos inoportunos de notificação: curva
...
% falar dos momentos inoportunos
